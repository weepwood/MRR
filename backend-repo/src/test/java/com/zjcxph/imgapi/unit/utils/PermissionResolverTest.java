...
class PermissionResolverTest {
    ...
    @Test
    @DisplayName("resolve — record:manage 展开为 manage+edit+read")
    void resolve_recordManage() {
        Set<String> result = PermissionResolver.resolve(List.of("record:manage"));
        assertThat(result).containsExactlyInAnyOrder("record:manage", "record:edit", "record:read");
    }
    ...
    void resolve_mixed() {
        ...
        assertThat(result).containsExactlyInAnyOrder(
                "record:manage", "record:edit", "record:read",
