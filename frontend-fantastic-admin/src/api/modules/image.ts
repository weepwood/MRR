...
/** GET /api/v1/img/export-image/{id} — 通过当前系统后端获取 PDF 合成所需原始影像 */
export function getImageForPdf(imageId: number | string) {
  return api.get<Blob>(`/api/v1/img/export-image/${imageId}`, {
    responseType: 'blob',
