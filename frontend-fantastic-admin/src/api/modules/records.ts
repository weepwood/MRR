...
export function getScanByCondition(request: Partial<ScanRequest>, page: number = 1, size: number = 10) {
  return postRequest<PaginatedResult<ScanRecord>>('/api/v1/scan/page/condition', request, {
    params: { page, size },
  })
}
...
export function findByCondition(request: ScanRequest) {
  return postRequest<ScanRecord[]>('/api/v1/scan/condition', request)
}
