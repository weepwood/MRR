...
if (import.meta.env.PROD) {
  ...
  if ((navigator.language).toLowerCase() === 'zh-cn') {
    console.info('%c由%cMRR-ADMIN%c驱动', copyright_sub_style, copyright_main_style, copyright_sub_style, '\nhttps://MRR-ADMIN.hurui.me')
  }
  else {
    console.info('%cPowered by%cMRR-ADMIN', copyright_sub_style, copyright_main_style, '\nhttps://MRR-ADMIN.hurui.me')
  }
}
