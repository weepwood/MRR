...
import type { LoginPageSettings } from '@/api/modules/login-page-settings'
...
.feature-icon { display: grid; flex: 0 0 auto; place-items: center; width: 34px; height: 34px; color: var(--mrr-primary); background: color-mix(in srgb, var(--mrr-primary) 10%, var(--mrr-card)); border: 1px solid color-mix(in srgb, var(--mrr-primary) 18%, var(--mrr-border)); border-radius: var(--mrr-radius-md); }
...
.brand-footer { position: relative; z-index: 1; display: flex; gap: var(--mrr-space-2); align-items: center; padding-top: var(--mrr-space-6); margin-top: auto; font-size: 11px; color: var(--mrr-muted-foreground); }
