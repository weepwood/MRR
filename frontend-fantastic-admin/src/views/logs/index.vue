...
function buildParams() {
  ...
  if (filters.clientIp.trim()) params.clientIp = filters.clientIp.trim()
  if (filters.requestUri.trim()) params.requestUri = filters.requestUri.trim()
  ...
  <div class="page-shell">
    <div class="page-header">
      <div>
        ...
        <h2>日志管理</h2>
        <p class="subtitle">支持按 URI、IP、状态码和时间范围快速检索系统访问日志。</p>
      </div>
