...
import { MEDICAL_RECORD_TYPE_CODES, getMedicalRecordTypeLabel } from '@/constants/medical-record-types'
...
async function searchByIdCard(idCard: string) {
  if (!idCard) { return }
    ...
    <div class="split-layout">
      ...
      <div class="left-pane">
        ...
        <div class="left-top">
          ...
          <!-- 病案结果列表 -->
          <div v-else-if="idSearchResults.length" class="id-results">
            <div
          ...
          <div v-else-if="!idSearchLoading && initDone" class="id-results-empty">
            <p>未查询到相关住院记录</p>
