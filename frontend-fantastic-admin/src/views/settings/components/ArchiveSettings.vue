  ...
  <section class="setting-section">
    ...
    <div class="setting-group">
      ...
      <div class="control-grid">
        ...
        <el-form-item label="缩略图宽度"><div class="slider-control"><el-slider v-model="settings.archiveThumbnailSize" :min="160" :max="320" :step="20" /><span>{{ settings.archiveThumbnailSize }} px</span></div></el-form-item>
