  ...
  <section class="setting-section">
    <div class="setting-group">
      ...
      <div v-if="settings.loginFeatureEnabled" class="advanced-copy">
        <div class="advanced-heading"><strong>功能介绍文案</strong><span>高级展示内容</span></div>
        <div class="feature-editor">
          <el-form-item label="功能 1 标题"><el-input v-model="settings.loginFeature1Title" maxlength="60" show-word-limit /></el-form-item>
          <el-form-item label="功能 1 说明"><el-input v-model="settings.loginFeature1Description" maxlength="120" show-word-limit /></el-form-item>
        </div>
        <div class="feature-editor">
          <el-form-item label="功能 2 标题"><el-input v-model="settings.loginFeature2Title" maxlength="60" show-word-limit /></el-form-item>
          <el-form-item label="功能 2 说明"><el-input v-model="settings.loginFeature2Description" maxlength="120" show-word-limit /></el-form-item>
        </div>
        <div class="feature-editor">
          <el-form-item label="功能 3 标题"><el-input v-model="settings.loginFeature3Title" maxlength="60" show-word-limit /></el-form-item>
          <el-form-item label="功能 3 说明"><el-input v-model="settings.loginFeature3Description" maxlength="120" show-word-limit /></el-form-item>
        </div>
      </div>
    </div>
    ...
    <div class="setting-group">
      ...
      <div class="control-grid" :class="{ disabled: !settings.systemAdminContactEnabled }">
        <el-form-item label="联系人或支持团队"><el-input v-model="settings.systemAdminDisplayName" :disabled="!settings.systemAdminContactEnabled" maxlength="60" /></el-form-item>
        <el-form-item label="所属部门"><el-input v-model="settings.systemAdminDepartment" :disabled="!settings.systemAdminContactEnabled" maxlength="60" /></el-form-item>
        <el-form-item label="联系电话"><el-input v-model="settings.systemAdminPhone" :disabled="!settings.systemAdminContactEnabled" maxlength="40" placeholder="推荐填写科室或值班电话" /></el-form-item>
        <el-form-item label="分机号"><el-input v-model="settings.systemAdminExtension" :disabled="!settings.systemAdminContactEnabled" maxlength="20" /></el-form-item>
        <el-form-item label="联系邮箱"><el-input v-model="settings.systemAdminEmail" :disabled="!settings.systemAdminContactEnabled" maxlength="100" /></el-form-item>
        <el-form-item label="服务时间"><el-input v-model="settings.systemAdminServiceHours" :disabled="!settings.systemAdminContactEnabled" maxlength="100" placeholder="例如 工作日 08:00–17:30" /></el-form-item>
      </div>
...
.setting-group, .login-preview { padding: var(--mrr-space-5); background: var(--mrr-card); border: 1px solid var(--mrr-border); border-radius: var(--mrr-radius-xl); }
...
.control-grid, .feature-editor { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: var(--mrr-space-4); }
...
.login-preview > span, .login-preview > small { font-size: 10px; color: var(--mrr-primary); text-transform: uppercase; letter-spacing: .08em; }
...
@media (max-width: 680px) { .control-grid, .feature-editor { grid-template-columns: 1fr; } }
</style>
