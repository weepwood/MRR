...
.sidebar-menu :deep(.el-menu-item:hover){background:rgba(0,63,177,.08);color:#1d4ed8}.sidebar-menu :deep(.el-menu-item.is-active){background:rgba(219,225,255,.55);color:#003fb1;font-weight:700;border-left:4px solid #003fb1}.sidebar-menu :deep(.el-menu-item .el-icon){font-size:18px}
