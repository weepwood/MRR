          ...
          <section class="docs-section">
            ...
            <div class="docs-grid">
              <article v-for="item in docsGenerators" :key="item.name" class="doc-card">
                ...
                <el-button class="doc-link" type="primary" plain @click="openExternal(item.url)">
...
.topbar-actions{display:flex;align-items:center;gap:10px}.icon-button{width:40px;height:40px;border:none;border-radius:999px;display:grid;place-items:center;background:transparent;color:#6b7280;cursor:pointer;transition:background-color .2s ease,color .2s ease}.icon-button:hover{background:#eef2f7;color:#1d4ed8}.topbar-divider{width:1px;height:32px;background:#e2e8f0;margin:0 4px}.topbar-copy{text-align:right;display:flex;flex-direction:column;align-items:flex-end}.topbar-role{font-size:13px;font-weight:700;color:#191c1d}.topbar-version{margin-top:2px;font-size:10px;text-transform:uppercase;letter-spacing:.14em;color:#737686}.logout-btn{border:none;border-radius:12px;background:linear-gradient(135deg,#003fb1,#1a56db);box-shadow:0 10px 24px rgba(0,63,177,.24)}
...
.hero-tools{display:flex;align-items:center;gap:12px;flex-wrap:wrap}.segmented{display:flex;padding:4px;border-radius:14px;background:#f3f4f5}.segmented button{border:none;border-radius:10px;background:transparent;padding:10px 16px;font-size:12px;font-weight:700;color:#5f6b84;cursor:pointer}.segmented button.active{background:#fff;color:#003fb1;box-shadow:0 2px 8px rgba(0,0,0,.06)}.export-btn{border:none;border-radius:12px;background:linear-gradient(135deg,#003fb1,#1a56db);box-shadow:0 10px 24px rgba(0,63,177,.22)}
