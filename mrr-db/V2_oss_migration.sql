-- ============================================
-- V2: OSS 迁移支持 - 完整数据库迁移脚本
-- 基于 migration_to_oss.sql 更新，增加 file_size / checksum_md5 字段
-- 执行前请务必备份数据！
-- ============================================
