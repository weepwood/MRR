...
values
    ('ADMIN', '系统管理员', '拥有完整的用户与权限管理能力', 'user:manage,role:manage,record:manage,log:read,system:read,test:read,statistics:read', 1),
    ('DOCTOR', '医生', '负责病案查询与业务处理', 'record:edit,search:read,statistics:read', 2),
