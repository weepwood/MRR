      ...
      '/ai-generation/系统架构/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Vue应用结构', link: '/ai-generation/系统架构/前端架构/Vue应用结构' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Spring Boot配置', link: '/ai-generation/系统架构/后端架构/Spring Boot配置' },
            { text: '异常处理与全局错误管理', link: '/ai-generation/系统架构/后端架构/异常处理与全局错误管理' }
          ]
        },
        {
          text: '控制器层架构',
          ...
          items: [
            ...
            { text: '扫描功能控制器', link: '/ai-generation/系统架构/后端架构/控制器层架构/扫描功能控制器' },
            { text: '图像管理控制器', link: '/ai-generation/系统架构/后端架构/控制器层架构/图像管理控制器' },
            { text: '用户管理控制器', link: '/ai-generation/系统架构/后端架构/控制器层架构/用户管理控制器' },
            { text: '统计分析控制器', link: '/ai-generation/系统架构/后端架构/控制器层架构/统计分析控制器' },
            { text: '日志管理控制器', link: '/ai-generation/系统架构/后端架构/控制器层架构/日志管理控制器' },
            { text: '搜索控制器', link: '/ai-generation/系统架构/后端架构/控制器层架构/搜索控制器' },
            { text: '系统信息控制器', link: '/ai-generation/系统架构/后端架构/控制器层架构/系统信息控制器' },
            { text: '压力测试控制器', link: '/ai-generation/系统架构/后端架构/控制器层架构/压力测试控制器' },
            { text: '数据库操作控制器', link: '/ai-generation/系统架构/后端架构/控制器层架构/数据库操作控制器' }
          ]
        },
        {
          text: '服务层架构',
          ...
          items: [
            ...
            { text: 'PDF处理服务', link: '/ai-generation/系统架构/后端架构/服务层架构/PDF处理服务' }
          ]
        },
        {
          text: '数据访问层',
          ...
          items: [
            ...
            { text: '扫描记录Mapper', link: '/ai-generation/系统架构/后端架构/数据访问层/扫描记录Mapper' },
            { text: '用户认证Mapper', link: '/ai-generation/系统架构/后端架构/数据访问层/用户认证Mapper' },
            { text: '用户信息Mapper', link: '/ai-generation/系统架构/后端架构/数据访问层/用户信息Mapper' },
            { text: '统计数据Mapper', link: '/ai-generation/系统架构/后端架构/数据访问层/统计数据Mapper' },
            { text: '搜索查询Mapper', link: '/ai-generation/系统架构/后端架构/数据访问层/搜索查询Mapper' },
            { text: '日志记录Mapper', link: '/ai-generation/系统架构/后端架构/数据访问层/日志记录Mapper' },
            { text: '角色权限Mapper', link: '/ai-generation/系统架构/后端架构/数据访问层/角色权限Mapper' }
          ]
        },
        {
          text: '数据架构',
      ...
      '/ai-generation/前端组件/': [
        {
          ...
          items: [
            ...
            { text: '对话框与通知组件', link: '/ai-generation/前端组件/对话框与通知组件' },
            { text: '影像浏览组件', link: '/ai-generation/前端组件/影像浏览组件' },
            { text: '认证组件', link: '/ai-generation/前端组件/认证组件' },
            { text: '管理员管理组件', link: '/ai-generation/前端组件/管理员管理组件' },
            { text: '统计详情页面响应式设计', link: '/ai-generation/前端组件/统计详情页面响应式设计' }
          ]
        }
      ],
      '/ai-generation/后端API文档/': [
        {
          text: '后端API文档',
          items: [
            { text: '后端API文档', link: '/ai-generation/后端API文档/后端API文档' },
            { text: '认证授权API', link: '/ai-generation/后端API文档/认证授权API' },
            { text: '扫描记录API', link: '/ai-generation/后端API文档/扫描记录API' },
            { text: '影像管理API', link: '/ai-generation/后端API文档/影像管理API' },
            { text: '统计分析API', link: '/ai-generation/后端API文档/统计分析API' },
            { text: '搜索查询API', link: '/ai-generation/后端API文档/搜索查询API' },
            { text: '日志管理API', link: '/ai-generation/后端API文档/日志管理API' },
            { text: '系统信息API', link: '/ai-generation/后端API文档/系统信息API' },
            { text: '压力测试API', link: '/ai-generation/后端API文档/压力测试API' }
          ]
        }
      ],
      '/ai-generation/数据库设计/': [
        {
          ...
          items: [
            ...
            { text: '数据迁移与版本管理', link: '/ai-generation/数据库设计/数据迁移与版本管理' }
          ]
        },
        {
          text: '核心业务表',
          ...
          items: [
            ...
            { text: 'mr_patient（患者表）', link: '/ai-generation/数据库设计/核心业务表/mr_patient（患者表）' },
            { text: 'mr_scan（扫描记录表）', link: '/ai-generation/数据库设计/核心业务表/mr_scan（扫描记录表）' },
            { text: 'mr_statistics（统计表）', link: '/ai-generation/数据库设计/核心业务表/mr_statistics（统计表）' }
          ]
        },
        {
          text: '认证授权表',
          ...
          items: [
            ...
            { text: '用户表 (mr_auth_user)', link: '/ai-generation/数据库设计/认证授权表/用户表 (mr_auth_user)' },
            { text: '角色表 (mr_auth_role)', link: '/ai-generation/数据库设计/认证授权表/角色表 (mr_auth_role)' },
      ...
      '/ai-generation/认证授权/': [
        {
          ...
          items: [
            ...
            { text: 'JWT认证机制', link: '/ai-generation/认证授权/JWT认证机制' },
      ...
      '/ai-generation/部署运维/': [
        {
          ...
          items: [
            ...
            { text: 'CI_CD流水线', link: '/ai-generation/部署运维/CI_CD流水线' }
          ]
        }
      ],
      '/ai-generation/guide/': [
        {
          ...
          items: [
            ...
            { text: '当前版本使用说明', link: '/ai-generation/guide/当前版本使用说明' },
